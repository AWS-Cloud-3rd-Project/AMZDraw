...
import com.amzmall.project.config.jwt.JwtRequestFilter;
...
public class SecurityConfig{
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .requestMatchers("/api/v1/auth/login", "/api/v1/auth/sign-up","/v3/**", "/swagger-ui/**","/api/v1/**").permitAll() // 로그인 및 회원가입 경로는 모두에게 접근 허용
